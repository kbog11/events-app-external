  ...
  it('responds with home page', function (done) {
    ...
    nock("http://localhost:8082")
      ...
      .reply(200, {
        "status": 200,
        "events": [
          { title: 'an event', id: 1234, description: 'something really cool', location: 'Uncle Julio', likes: 0 },
          { title: 'another event', id: 5678, description: 'something even cooler', location: 'El Centro', likes: 0 }
        ]
      });
